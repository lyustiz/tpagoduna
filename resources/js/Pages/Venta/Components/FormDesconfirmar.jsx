...
const FormDesconfirmar = ({ open, OnClose, venta }) => {
  ...
  const handleConfirm = (e) => {
    ...
    post(route("ventas.desconfirmar", { id: data.id }), {
      onSuccess: (response) => {
    ...
    <>
      ...
      <Dialog open={open} onClose={() => handdleClose(false)}>
        <form action="" method="post">
          <DialogTitle>Desconfirmar Venta</DialogTitle>
          <DialogContent>
            <Typography variant="body1" gutterBottom>
              ¿Estás seguro de que deseas desconfirmar la venta?
            </Typography>
...
export default FormDesconfirmar;
